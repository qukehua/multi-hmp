...
class Trainer:
    def __init__(self, args):
        ...
        self.learning_rate = args.pretrain_lr
        self.num_epoch = args.pretrain_num_epoch
    ...
    def train(self):
        ...
        for train_iter in range(start_epoch, self.num_epoch):
            ...
            for i, data in enumerate(self.train_loader):
                ...
                pred_vel = self.model(input_joint)
                pred_vel = pred_vel[:, :, 16:]
                ...
                # [B, NxJ, T=30, 3]
                gt_vel_x = gt_vel[:, :, :16]
                # print(gt_vel_x.shape)  # (128,26,16,3)
                gt_vel_y = gt_vel[:, :, 16:]
                # print(gt_vel_y.shape)  #(128,26,14,3)


                loss_pred = distance_loss(pred_vel, gt_vel_y)
                loss = loss_pred * self.weight_loss_pred
